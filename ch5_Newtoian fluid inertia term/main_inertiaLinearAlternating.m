...
while 1
    ...
    F1 = zeros(noNodesV, 1);
    F2 = zeros(noNodesV, 1);
    Q1 = zeros(noNodesV,noNodesV);
    Q2 = zeros(noNodesV,noNodesV);
    ...
    for e = 1:noElement
        ...
        JXYe = JXYV(JMV(e,:),:);
        velocityE = [velocityX_pre(JMV(e,:),1), velocityY_pre(JMV(e,:),1)];
        ...
        [Qe1, Qe2] = compute_Qe(JXYe, velocityE, rho, gaussPts, gaussWts);
        
        Q1(JMV(e,:),JMV(e,:)) = Q1(JMV(e,:),JMV(e,:)) + Qe1;
        Q2(JMV(e,:),JMV(e,:)) = Q2(JMV(e,:),JMV(e,:)) + Qe2;
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%     迭代步骤C.4   %%%%%%%%%
    %%%%%%%      压力边界条件代入     %%%%%%
